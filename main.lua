...
elseif game.PlaceId == 120575147399256 then
   repeat task.wait() until _G.Window
   loadstring(game:HttpGet("https://raw.githubusercontent.com/nexsnus/Novus.gg/refs/heads/main/ClickerSimulatorX/ClickerSimulatorXmain.lua"))()   
end
